...
def train(args):
    ...
    # TensorBoard writer for tracking losses and metrics over steps
    ...
    while total_steps < args.num_steps:
        for i_batch, train_data_blob in enumerate(train_loader):
            ...
            # TensorBoard logging
            writer.add_scalar("loss/total_3d", loss.item(), total_steps)
            writer.add_scalar("loss/2d", metrics['loss_2d'], total_steps)
            writer.add_scalar("loss/3d", metrics['loss_3d'], total_steps)
            writer.add_scalar("loss/rv", metrics['loss_rv'], total_steps)
            writer.add_scalar("metrics/epe2d", metrics['epe2d'], total_steps)
            writer.add_scalar("metrics/epe3d", metrics['epe3d'], total_steps)
            writer.add_scalar("metrics/1px", metrics['1px'], total_steps)
            writer.add_scalar("metrics/5cm", metrics['5cm'], total_steps)
            writer.add_scalar("metrics/10cm", metrics['10cm'], total_steps)
